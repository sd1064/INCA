...
% MLP
% trainingFunction = 'trainlm';
% [outputTrainMLPLM , lmtime]= patterNetRepeat(possibleNeuronSize ,numLayers ,timesRepeated , ... 
%     stepSize ,inputData ,oneHotTarget , ...
%     training,validation,test,final,trainingFunction);

% trainingFunction = 'trainscg';
% [outputTrainMLPSCG, scgtime] = patterNetRepeat(possibleNeuronSize ,numLayers ,timesRepeated , ... 
%     stepSize ,inputData ,oneHotTarget , ...
%     training,validation,test,final,trainingFunction);
